...
Start-Process PowerShell -ArgumentList "-NoLogo -Command {Set-ExecutionPolicy RemoteSigned -Force; Install-PackageProvider -Name NuGet -MinimumVersion 2.8.5.201 -Force; Import-PackageProvider -Name NuGet -Force}" -Wait
